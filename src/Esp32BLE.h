 ...
 * 
 *  -----------------------------------------------
 *  ESP32 implementation here (https://github.com/precision/science-journal-arduino/tree/esp32)
 * 
 * ------------------------------------------------
 * 2021 Feb. Jon Robinson (aegis1980) 
 * This version refactors to separate file (Esp32BLE.h). 
 * Do want you wish with it, so long as you abide the requirements of 
